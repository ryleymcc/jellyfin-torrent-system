...
| -------------- | ---------------------------------------------- | --------------------------------- | ----------------------------------------------------------------------------------------------- |
| 1337x          | 1337x                                          | <https://1337xx.to>                 | [/find/1337x/avengers](https://itorrentsearch.vercel.app/find/1337x/avengers)                   |
| Yts            | yts                                            | <https://yts.mx>                    | [/find/yts/avengers](https://itorrentsearch.vercel.app/find/yts/avengers)                       |
| Eztv           | eztv                                           | <https://eztv.re>                   | [/find/eztv/avengers](https://itorrentsearch.vercel.app/find/eztv/avengers)                     |
| Torrent Galaxy | tgx                                            | <https://torrentgalaxy.to>          | [/find/tgx/avengers](https://itorrentsearch.vercel.app/find/tgx/avengers)                       |
| Torlock        | torlock                                        | <https://www.torlock.com>           | [/find/torlock/avengers](https://itorrentsearch.vercel.app/find/torlock/avengers)               |
| PirateBay      | piratebay                                      | <https://thehiddenbay.com>          | [/find/piratebay/avengers](https://itorrentsearch.vercel.app/find/piratebay/avengers)           |
| Nyaasi      | nyaasi                                         | <https://nyaa.si>                   | [/find/nyaasi/umaru](https://itorrentsearch.vercel.app/find/nyaasi/umaru)                       |
| Rarbg          | rarbg                                          | <https://rargb.to>                  | [/find/rarbg/avengers](https://itorrentsearch.vercel.app/find/rarbg/avengers)                   |
| ~~Ettv~~           | ~~ettv~~                                           | ~~<https://www.ettvcentral.com>~~       | DEAD                     |
| ~~Zooqle~~         | ~~zooqle~~                                         | ~~<https://zooqle.com>~~                | DEAD                 |
| KickAss        | kickass                                        | <https://kickasstorrents.to>        | [/find/kickass/avengers](https://itorrentsearch.vercel.app/find/kickass/avengers)               |
| Bitsearch      | bitsearch                                      | <https://bitsearch.to>              | [/find/bitsearch/avengers](https://itorrentsearch.vercel.app/find/bitsearch/avengers)           |
| Glodls         | glodls                                         | <https://glodls.to/home.php>        | [/find/glodls/avengers](https://itorrentsearch.vercel.app/find/glodls/avengers)                 |
| ~~MagnetDL~~       | ~~magnetdl~~                                       | ~~<https://www.magnetdl.com>~~          | DEAD            |
| LimeTorrent    | limetorrent                                    | <https://www.limetorrents.pro/home> | [/find/limetorrent/avengers](https://itorrentsearch.vercel.app/find/limetorrent/avengers)       |
| TorrentFunk    | torrentfunk                                    | <https://www.torrentfunk.com>       | [/find/torrentfunk/avengers](https://itorrentsearch.vercel.app/find/torrentfunk/avengers)       |
| TorrentProject | torrentproject                                 | <https://torrentproject2.com>       | [/find/torrentproject/avengers](https://itorrentsearch.vercel.app/find/torrentproject/avengers) |
| all            | all (It will retrieve torrent from every site) |                                   | [/find/all/avengers](https://itorrentsearch.vercel.app/find/all/avengers)                       |
...
```
https://itorrentsearch.vercel.app/find/{keyword}/{query}/{page(optional)}
```

🔰Example
```
https://itorrentsearch.vercel.app/find/1337x/avengers/3
```
